...
class UpdateDownloader extends AsyncTask<Void, Integer, Long> {
    ...
    public UpdateDownloader(UpdateParams agent, Context context, String url, File file) {
        super();
        mContext = context;
        mAgent = agent;
        mUrl = url;
    ...
    protected void onPostExecute(Long result) {
        Log.i("我的信息","onPostExecute："+result);
